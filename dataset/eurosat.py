...
class EuroSATBase:
    def __init__(self,
        ...
        # Data loading code
        if is_train:
            traindir = os.path.join(location, 'eurosat-dataset', 'train')
            ...
            valdir = os.path.join(location, 'eurosat-dataset', 'val')
            testdir = os.path.join(location, 'eurosat-dataset', 'test')
